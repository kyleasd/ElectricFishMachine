...
internal static class ElectricFishMachineMenuDrawPatch
{
        ...
        bool drawShadow)
    {
        ...
        Texture2D tex = Game1.content.Load<Texture2D>(ElectricFishMachineContent.ElectricFishMachineTexture);
        Rectangle source = ElectricFishMachineContent.GetSpriteSourceRect(0);
        float drawScale = scaleSize * MenuScaleCorrection;
        ...
        if (drawShadow)
        {
            spriteBatch.Draw(
                ...
                source,
                Color.Black * (0.35f * transparency),
                0f,
                Vector2.Zero,
                drawScale,
                SpriteEffects.None,
