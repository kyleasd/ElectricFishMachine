...
/// <summary>
/// Generic Mod Config Menu API 镜像（与 <c>spacechase0.GenericModConfigMenu</c> 的 <c>IApi</c> 对齐）。
/// 见 <see href="https://stardewmodding.wiki.gg/wiki/Generic_Mod_Config_Menu/Reference">GMCM Reference</see>。
/// </summary>
